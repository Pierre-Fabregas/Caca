...
public class Revetement {
    ...
    public static void setRevetementfichier(File Revetementfichier) {
        Revetement.Revetementfichier = Revetementfichier;
    }
    ...
    public static File getRevetementfichier() {
        return Revetementfichier;
    }
